...
// yuh
  ...
  override def start(): Unit = {
    ...
    //       val model = "deepseek-ai/DeepSeek-R1-0528"
    //       val url = new URL(s"https://router.huggingface.co/together/v1/completions")
    ...
    //                 {
    //                   "role": "user",
    //                   "content": "Answer in 1 sentence: $escapedMessage, using this context $year_Data"
    //                 }
    //               ],
    //               "model": "$model"
    //             }
    ...
    //         val answer = responseStr.split("\"text\":")(1).split("</think>")(1).split("\"")(0).replace("\\n", "\n")
