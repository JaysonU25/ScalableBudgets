error id: C241B46784F5789D3A56214A9624B3BD
...
object Main extends JFXApp3 {
  ...
  override def start(): Unit = {
    ...
    def lazy val analyze_screen: Scene = new Scene{

      val data = @@db.getMonthTotals("2025") // returns Map[String, Double] = Map("Food" -> 120.0, "Rent" -> 400.0)
      ...
      content = new VBox{
        spacing = 10
        children = Seq(new Label("Charts"), new Button("HOME") { onAction = _ => stage.scene = home_screen})
      }
    }
...
scala.reflect.internal.Definitions$DefinitionsClass.isByNameParamType(Definitions.scala:428)
	...
	scala.tools.nsc.interactive.Global.stabilizedType(Global.scala:975)
	scala.tools.nsc.interactive.Global.typedTreeAt(Global.scala:823)
	scala.meta.internal.pc.AutoImportsProvider.autoImports(AutoImportsProvider.scala:27)
