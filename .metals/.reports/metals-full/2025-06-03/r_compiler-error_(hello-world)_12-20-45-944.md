...
### scala.reflect.internal.Types$TypeError: illegal cyclic reference involving class VBox
    ...
    lazy val view_expenses: Scene = new Scene{
        ...
        children = Seq(new Label("View your expenses"), new Label("Which year would you like to view:"), new ComboBox[String](tables) { 
          ...
          onAction = _ => {
            ...
            val expenses = database.viewYear(selected, Option(selected_month.text.value).getOrElse("."))
            table.items = toFX(expenses)
            } 
          }, 
          new Label("Which month did it fall under:"),  new ComboBox[String]@@, table, new Button("HOME") { onAction = _ => stage.scene = home_screen})
      }
    }
