...
object Main extends JFXApp3 {
  ...
  override def start(): Unit = {
    ...
    lazy val analyze_screen: Scene = new Scene{
      ...
      val data = database.getPieChartData(Option(@@selected_year.text.value) // returns Map[String, Double] = Map("Food" -> 120.0, "Rent" -> 400.0)
      ...
      content = new VBox{
        spacing = 10
        children = Seq(new Label("Charts"), pieChart, new Button("HOME") { onAction = _ => stage.scene = home_screen})
      }
    }
