...
object Main extends JFXApp3 {
  ...
  override def start(): Unit = {
    ...
    val screenstyle = "-fx-background-color:rgb(81, 119, 78); -fx-padding: 19px; -fx-font-size: 16px; minHeight: 600px; minWidth: 800px;"
    // Screens
    def home_screen(stage: Stage, database: Database, months: Seq[String], years: List[String]): Scene = new Scene{
    val homeButtonStyle = "-fx-background-color: transparent; -fx-text-fill: black; -fx-border-color: transparent;"
      content = new VBox {
        style = screenstyle
        minWidth = 800
        minHeight = 600
    ...
    def new_table(stage: Stage, database: Database): Scene = new Scene{
      ...
      new_year.setStyle("-fx-background-color: transparent; -fx-text-fill: black; -fx-border-color: transparent;")
      content = new VBox { 
        style = screenstyle
        minWidth = 800
        minHeight = 600
    ...
    def new_expense_screen(stage: Stage, database: Database, months: Seq[String], tables: List[String]): Scene = new Scene{
        ...
        val which_year = new Label("Which year would you like to add?")
        new_year@@.setStyle("-fx-background-color: transparent; -fx-text-fill: black; -fx-border-color: transparent;")
        val which_month = new Label("Which year would you like to add?")
        which.setStyle("-fx-background-color: transparent; -fx-text-fill: black; -fx-border-color: transparent;")
        content = new VBox { 
        style = screenstyle  
        minWidth = 800
        minHeight = 600
        spacing = 30
        children = Seq(add_expense_text, new Label("Which year did it fall under:"), new ComboBox[String](tables) { 
    ...
    def helpPage(stage: Stage, database: Database, months: Seq[String], years: List[String]): Scene = {
      new Scene {
        content = new VBox {
          ...
          spacing = 10
          children = Seq(
            new Label("Common Help"),
            new Label("1. To add a new year, go to 'Add a new year' and enter the year."),
            new Label("2. To add expenses, go to 'Add Expenses/Income' and fill in the details."),
            new Label("3. To view expenses, go to 'View Expenses/Incomes' and select the year and month."),
    ...
    def budgetTips(stage: Stage, database: Database, months: Seq[String], years: List[String]): Scene = {
      ...
      val savingsCalculator = new HBox {
