...
### scala.reflect.internal.Types$TypeError: illegal cyclic reference involving object KeyCode
...
object Main extends JFXApp3 {
  ...
  override def start(): Unit = {
    ...
    lazy val analyze_screen: scalafx.scene.Scene{} = new Scene{
      ...
      content = new VBox{
        spacing = 10
        children = Seq(new Label("Charts") ,new Button("Categories") { onAction = _ => {stage.scene = pieChartScene(stage, database, years = tables, months = months_list)}}, new Button("Months"){ onAction = _ => stage.scene = barChartScene(stage, database, tables)},new Button("HOME") { onAction = _ => stage.scene = home_screen})
      }
    }
    ...
    def histogramChartScene(stage:Stage, database: Database, years: List[String], months:Seq[String]):String = {
      val xAxis = new CategoryAxis()
      xAxis.setLabel("Year")
      ...
      val month = new ComboBox[String](months)

      val layout = new VBox(10, months, lineChart, backButton)
